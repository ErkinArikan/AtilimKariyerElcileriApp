...
//import SwiftUI
//
//struct myTabBar2: View {
//    @AppStorage("selectedTab2") var selectedTab2:Tab2 = .house
//    var body: some View {
//        VStack {
//            Spacer()
//            HStack {
...
//}
//
//var tabItems2:[TabItems2] = [s
//    TabItems2(icon: "person", iconFill: "person.fill", tab: .people),
//    TabItems2(icon: "house", iconFill: "house.fill", tab: .house),
//    TabItems2(icon: "gearshape", iconFill: "gearshape.fill", tab: .gear)
//]
//
//
//enum Tab2:String{
