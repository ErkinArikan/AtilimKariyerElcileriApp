...
struct MockPersonListRowView: View {
                ...
                Image("FlippedCard2")
                    ...
                    .overlay(alignment: .top) {
                        Image(person.backwardImage)
                             .resizable()
                             .scaledToFit()
                             .background(Color.MyBackgroundColor2.clipShape(Circle()).shadow(color:.black,radius: 5))
                             .frame(width: 80)
                             .scaleEffect(x: -1)
...
#Preview {
    ZStack(content: {
        ...
        MockPersonListRowView(person: examplePersonObj)
    })
